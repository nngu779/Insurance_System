...
public class MainTest {
  public static class Task1 extends CliTest {
    ...
    @Test
    public void T1_07_check_unique_names() throws Exception {
      runCommands(CREATE_PROFILE, "jorDan", "21", CREATE_PROFILE, "jORdan", "23", PRINT_DB);
      assertContains("Database has 1 profile:");
      assertContains("1: Jordan, 21");
      assertDoesNotContain("2: Jordan, 23");
    }
